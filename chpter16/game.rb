...
class Game
    ...
    def start
        ...
        if player1_hand > player2_hand
            puts "player1 win"
            @result << [player1_cards, player1_hand, player2_cards, player2_hand, "player1"]
    ...
    def win_ratio
        ...
        win_ratio_of_player1 = group_by_winner["player1"].size / matches.to_f 
        win_ratio_of_player2 = group_by_winner["player2"].size / matches.to_f 
